...
namespace TEER.Controllers
{
    public class ComputerInformationController : Controller
    {
        ...
        public ActionResult ViewComputerInformation()
        {
            ...
            //ViewBag.GetProcessorId = GetProcessorId();
            //ViewBag.GetHDDSerialNo = GetHDDSerialNo();
            //ViewBag.GetBoardMaker = GetBoardMaker();
            //ViewBag.GetBoardProductId = GetBoardProductId();
            //ViewBag.GetProcessorInformation = GetProcessorInformation();
            //ViewBag.GetOSInformation = GetOSInformation();
            //ViewBag.GetCurrentLanguage = GetCurrentLanguage();
            //ViewBag.GetCpuSpeedInGHz = GetCpuSpeedInGHz();
            //ViewBag.GetDefaultIPGateway = GetDefaultIPGateway();
            //ViewBag.GetCPUCurrentClockSpeed = GetCPUCurrentClockSpeed();
            //ViewBag.GetCPUManufacturer = GetCPUManufacturer();
            //ViewBag.GetNoRamSlots = GetNoRamSlots();
            //ViewBag.GetPhysicalMemory = GetPhysicalMemory();
            //ViewBag.GetAccountName = GetAccountName();
            //ViewBag.GetBIOScaption = GetBIOScaption();
